...
class DiasporaStreamOctopus(CMakePackage):
    ...
    version("0.2.0", sha256="c37c629033eec2136530e7c06b92075ca9641cde5498eb1b8b87b420516d4b42")
    version("0.1.2", sha256="3a10842f9b49795a6e8b1c0e789fc16b7ddf3da739b174fed49446f802505047")
    ...
    depends_on("diaspora-stream-api@0.5.1:", when="@0.1.1:")
    depends_on("librdkafka+sasl")
    depends_on("uuid")
    depends_on("curl", when="@0.2.0:")
